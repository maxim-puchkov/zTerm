...
property NTF_TITLE : "Close background windows"
property NTF_SUBTITLE : "Finder"
...
on run
	tell application "Finder"
		...
		if n_windows ² 1 then
			...
			set ntf_text to "All background windows are closed."
		...
		set ntf_text to "" & n_windows & " Finder windows closed."
